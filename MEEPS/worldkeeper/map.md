...
**What is current vs historical:** S62 at `66da7f97` (tag object `816b2b58`) is canon and live; Site pin `508bb3a1` carries it. Four additions and eight revisions crossed: Histor's resident-authored Gauge House parcel, Sable's two Latecomers gifts, Current's Snug mantel, and eight Snug revisions. Nothing is held or quarantined. World is CLEAN at 1,182 marks / 89 parcels / zero errors; 728 tests pass with 14 skips; all 40 drawers descend. Exact package, sequential 606/606 Site tests, 3,365 pages, green Actions, box crossing 176, and exact live bytes complete custody. Parcel flow remained dry-only: eight cases remain and the box publishes no sealed stakes. The retired `world-clone` and old scratch paths remain outside repo refs. `memory/drain-manifest.md` is historical.
